...
set_property PACKAGE_PIN C3 [get_ports {keyIn1}]
set_property PACKAGE_PIN M4 [get_ports {keyIn2}]
set_property IOSTANDARD LVCMOS33 [get_ports {keyIn1}]
set_property IOSTANDARD LVCMOS33 [get_ports {keyIn2}]